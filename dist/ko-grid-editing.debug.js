...
;(function(factory) {
    if (typeof define === 'function' && define['amd'])
        define(['ko-grid', 'knockout', 'ko-grid-cell-navigation', 'ko-data-source', 'ko-indexed-repeat'], factory);
    else
        window['ko-grid-editing'] = factory(window.ko.bindingHandlers['grid'], window.ko);
